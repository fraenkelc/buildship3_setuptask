 ...
 * @generated
 */
public class ImportGradleProjectSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  public ImportGradleProjectSwitch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    ...
    {
      ImportGradleProjectTask importGradleProjectTask = (ImportGradleProjectTask)theEObject;
      T result = caseImportGradleProjectTask(importGradleProjectTask);
      if (result == null)
      {
        result = caseSetupTask(importGradleProjectTask);
      }
      if (result == null)
      {
        result = caseModelElement(importGradleProjectTask);
      }
      if (result == null)
      {
   ...
   * @generated
   */
  public T caseImportGradleProjectTask(ImportGradleProjectTask object)
  {
    return null;
  }
