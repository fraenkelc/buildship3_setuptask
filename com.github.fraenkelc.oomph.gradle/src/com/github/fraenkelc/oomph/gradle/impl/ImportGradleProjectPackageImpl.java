...
public class ImportGradleProjectPackageImpl extends EPackageImpl implements ImportGradleProjectPackage
{
   ...
   *
   * <p>This method is used to initialize {@link ImportGradleProjectPackage#eINSTANCE} when that field is accessed.
  ...
  public static ImportGradleProjectPackage init()
  {
    if (isInited)
    {
      return (ImportGradleProjectPackage)EPackage.Registry.INSTANCE.getEPackage(ImportGradleProjectPackage.eNS_URI);
    }
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(importGradleProjectTaskEClass, ImportGradleProjectTask.class, "ImportGradleProjectTask", !IS_ABSTRACT, !IS_INTERFACE,
        IS_GENERATED_INSTANCE_CLASS);
    initEReference(getImportGradleProjectTask_SourceLocators(), theResourcesPackage.getSourceLocator(), null, "sourceLocators", null, 1, -1,
        ImportGradleProjectTask.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createEcoreAnnotations()
  {
    ...
    addAnnotation(this, source,
        new String[] { "schemaLocation", "http://www.github.com/fraenkelc/buildship3_setuptask/schemas/Buildship3_setuptask-1.0.ecore" });
  }
  ...
  protected void createEnablementAnnotations()
  {
    ...
    addAnnotation(importGradleProjectTaskEClass, source, new String[] { "variableName", "p2.import.gradle.project", "repository",
        "http://www.github.com/fraenkelc/buildship3_setuptask/updates", "installableUnits", "buildship3_setuptask.feature.group" });
  }
